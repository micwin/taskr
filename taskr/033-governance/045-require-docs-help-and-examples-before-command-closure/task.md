...
updated_at: 2026-08-10T10:03:30Z
---

# Description

Update the Taskr agent/project policy so tickets that add or change commands,
subcommands, flags, or user-visible command behavior cannot move to `done`
until documentation, command help, and examples are complete.
...
- The policy applies before setting a ticket to `done`.
